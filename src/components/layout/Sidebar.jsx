...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar Drawer - Fixed to Left Viewport */}
      <aside
        className={`fixed md:sticky top-0 inset-y-0 left-0 z-40 md:z-30 w-64 h-screen shrink-0 bg-white border-r border-slate-200 flex flex-col justify-between select-none transform transition-transform duration-300 ease-in-out md:translate-x-0 shadow-xs ${
        ...
        <div>
          <div className="h-16 flex items-center justify-between px-6 border-b border-slate-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-bold tracking-wider text-slate-900 text-base">AI DIALER</span>
                <span className="block text-[10px] font-semibold tracking-widest text-indigo-600 uppercase">MVP Edition</span>
              </div>
            </div>
